...
def main(test_id):
    ...
    if test_id == 'pca':
        ...
        xm_vis.matrix_as_heatmap_complex(
        ...
        for l in ls:
            ...
            xm_vis.matrix_as_heatmap(sph_func_recon, outpath=join(tmp_dir, 'sph_recon_l%03d.png' % l))
